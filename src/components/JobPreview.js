...
import { FaClock, FaMapMarkerAlt, FaChevronLeft, FaAccessibleIcon } from 'react-icons/fa';
      ...
      <ParentWrapper toggled={toggled}>
        <Front toggled={toggled} onClick={this.handleOnClick}>
          ...
          <JobInfo>
            ...
            <FlexWrapper>
              <Icon>
                <FaAccessibleIcon size={10} color="gray" />
              </Icon>
              <Text>HTML, JavaScript, React, CSS</Text>
            </FlexWrapper>
          </JobInfo>
